...
import HeaButton from "../components/CustomButton";
  ...
  return (
    ...
    >
      <Box className={classes.dialogModalContainer}>
        ...
        {/* BOTTOM Buttons Section: This section will show two type of button , if dialogNumber is 1 then it will show reconfigure. If dialogNumber is 12 then it won't show next buttonu */}
        <Box
